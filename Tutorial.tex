...
\def\mtrnr{1234567}
\def\datum{\today}
\def\titel{Einf\"uhrung in LaTeX}
\def\artderdoku{\LaTeX\ Tutorial}
\def\ethz{Eidgen\"ossische~Technische~Hochschule~Z\"urich}
\def\department{Informatikdienste}
\def\institut{Procurement and Portfolio Management}
\def\professur{Portfolio Management}
\def\professor{Dordaneh Arangeh}
\def\studienjahrgang{2019}
\def\betreuer{Fabio Consani}
...
%
% Hinweis zur Kapitelnummerierung: Soll der Punkt hinter der letzen Zahl der
%                                  letzten Kapitel-Nummer nicht vorhanden sein,
%                                  So kann in der folgenden Zeile der Eintrag
%
...
\usepackage{ulem}
\usepackage{url}
\urldef{\Kompendium}\url{https://de.wikibooks.org/wiki/LaTeX-Kompendium:_F%C3%BCr_Mathematiker}
%
%
%
% ============================================================================
% Package für Symbole und Formeln:
% ============================================================================
%
...
%
% ============================================================================
% Package für Literaturverzeichnis benötigt eine
% spezielle Einstellung in TexMaker:
%
%  -> Optionen -> Texmaker konfigurieren -> schnelles Übersetzen
%     den zweit-obersten Eintrag (PdfLaTeX + bib(la)tex + PdfLaTeX(x2) - PDF anzeigen) auswählen
% ============================================================================
%
...
% ============================================================================
%
% Ab diesr Stelle werden Kapitel und Unterkapitel nummeriert und automatisch
...
\begin{spacing}{1.25}
\input{./Inhalte/InhaltStruktur.tex}
\end{spacing}
%
%
%
...
\begin{spacing}{1.25}
\input{./Inhalte/TextErfassen.tex}
\end{spacing}
%
%
...
\begin{spacing}{1.25}
\input{./Inhalte/TextFormatieren.tex}
\end{spacing}
%
%
\subsubsection{Gliederung / Strukturierung}
\begin{spacing}{1.25}
\input{./Inhalte/GliederungStrukturierung.tex}
\end{spacing}
%
%
\subsubsection{Absätze}
\begin{spacing}{1.25}
\input{./Inhalte/TextFormatierenAbsatz.tex}
\end{spacing}
%
%
\subsubsection{Schriftarten und Farben}
\begin{spacing}{1.25}
\input{./Inhalte/TextFormatierenFarben.tex}
\end{spacing}
%
%
\subsubsection{Aufzählungen \& Bullet-Points}
\begin{spacing}{1.25}
\input{./Inhalte/TextBulletPoints.tex}
\end{spacing}
%
%
%
...
\begin{spacing}{1.25}
\input{./Inhalte/Tabellen_ohne_Schraffierung.tex}
\end{spacing}
%
%
\subsection{Tabellen mit Schraffierung}
\begin{spacing}{1.25}
\input{./Inhalte/Tabellen_mit_Schraffierung.tex}
\end{spacing}
%
%
\subsection{Tabellen - Alternativen}
\begin{spacing}{1.25}
\input{./Inhalte/Tabellen_Alternativen.tex}
\end{spacing}%
%
%
%
...
\label{Bilder}
\begin{spacing}{1.25}
\input{./Inhalte/Inhalt_Bilder.tex}
\end{spacing}
%
%
%
...
\begin{spacing}{1.25}
\input{./Inhalte/How_To_Abkuerzungen.tex}
\end{spacing}
%
%
\subsection{Erfassen von Abkürzungen}
\begin{spacing}{1.25}
\input{./Inhalte/How_To_Abkuerzungen_erfassen.tex}
\end{spacing}
%
%
\subsection{Einsetzen von Abkürzungen}
\begin{spacing}{1.25}
\input{./Inhalte/How_To_Abkuerzungen_einsetzen.tex}
\end{spacing}
%
%
\subsection{Verwenden von Abkürzungen}
\begin{spacing}{1.25}
\input{./Inhalte/How_To_Abkuerzungen_arbeiten.tex}
\end{spacing}
%
%
%
...
\begin{spacing}{1.25}
\input{./Inhalte/How_to_Fussnoten.tex}
\end{spacing}
%
%
\subsection{Erfassen von Fussnoten}
\begin{spacing}{1.25}
\input{./Inhalte/How_to_Fussnoten_erfassen.tex}
\end{spacing}
%
%
%
...
\label{Stichworte}
\begin{spacing}{1.25}
\input{./Inhalte/How_to_Stichworte.tex}
\end{spacing}
%
%
\subsection{Erfassen von Stichworten}
\begin{spacing}{1.25}
\input{./Inhalte/How_to_Stichworte_erfassen.tex}
\end{spacing}
%
%
%
...
\begin{spacing}{1.25}
\input{./Inhalte/How_to_Quellen_erfassen.tex}
\end{spacing}
%
%
\subsection{Verwenden von Quellen}
\begin{spacing}{1.25}
\input{./Inhalte/How_to_Quellen_verwenden.tex}
\end{spacing}
%
%
\subsection{Quellenverzeichnis erstellen}
\begin{spacing}{1.25}
\input{./Inhalte/How_to_Quellen_Verzeichnis.tex}
\end{spacing}
%
%
%
...
\begin{spacing}{1.25}
\input{./Inhalte/How_to_Formeln.tex}
\end{spacing}
%
%
\pagebreak 
...
\begin{spacing}{1.25}
\input{./Inhalte/How_to_Inline_Formeln.tex}
\end{spacing}
%
%
\pagebreak
...
\begin{spacing}{1.25}
\input{./Inhalte/How_to_Abgesetzte_Formeln.tex}
\end{spacing}
%
%
\pagebreak
...
\begin{spacing}{1.25}
\input{./Inhalte/How_to_Ausgerichtete_Formeln.tex}
\end{spacing}%
%
%
\pagebreak
...
\begin{spacing}{1.25}
\input{./Inhalte/How_to_Theorem_Proof.tex}
\end{spacing}%%
%
%
\pagebreak
...
\begin{spacing}{1.25}
\input{./Inhalte/How_to_Math_Beispiele.tex}
\end{spacing}%%
%
%
%
...
%
% ============================================================================
% Eiesstattliche Erklärung der Arbeit
% ============================================================================
%
\pagebreak 
\clearpage
...
\begin{spacing}{1.25}
\input{./Inhalte/Urheberschaft.tex}
\end{spacing}
%
%
%
